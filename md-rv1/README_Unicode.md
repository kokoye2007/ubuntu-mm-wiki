...
Google Chrome (http://www.google.com/chrome) သည် Google မှထုတ်သော browser တစ်ခုဖြစ်သည်။ Chromium browser ကိုအခြေခံထားပြီး၊ Google ၏ နာမည်၊ လိုဂိုအမှတ်တံဆိပ်၊ GoogleUpdate ဟုခေါ်သည့် အလိုအလျောက် Update စနစ်၊RZL နှင့် အခြား Google add-ons များပါ၀င်သည်။ Google Chrome ကို ဤနေရာမှ (http://www.google.com/chrome/eula.html) ဒေါင်းလုတ်လုပ်ပြီး၊ install လုပ်ပါ။

##Download Managers

Browsers များထက် ဒေါင်းလုတ်လုပ်ငန်းစဉ် လွယ်ကူပြီး၊ပိုမိုမြန်ဆန်စေရန်၊ အမှားနည်းစေရန် ပြုလုပ်ထားသော ဆော့လ်ဝဲများဖြစ်သည်။အချို့ Download Managers များတွင် အင်တာနက် ကွန်နက်ရှင်မကောင်းပါက ခဏရပ်တန့်ထားပြီး၊ နောင် ကွန်နက်ရှင်ပြန်ကောင်းမှ ဆက်လက်ဒေါင်းလုတ်နိုင်သော Resuming Downloads Option လဲပါ၀င်သည်။
...
Empathy (http://live.gnome.org/Empathy) ဆိုသည်မှာ Open Source IM ဆော့လ်ဝဲလ်တစ်ခုဖြစ်ပါသည်။ ဤဆော့လ်ဝဲသည် Ubuntu (Gnome) အသုံးပြုသော desktop များတွင် ပုံမှန်ပါ၀င်သော ဆော့လ်ဝဲတစ်ခုလည်းဖြစ်သည်။

    sudo apt-get install empathy

##Pidgin

Pidgin (http://www.pidgin.im/) ဆော့လ်ဝဲလ်သည် Open Source IM ဆော့လ်ဝဲလ်တစ်ခု ဖြစ်သည်။ ဤဆော့လ်ဝဲလ်သည် Ubuntu (Gnome) အသုံးပြုသော desktop များတွင် ပုံမှန်ပါ၀င်သော ဆော့လ်ဝဲလ်တစ်ခုလည်းဖြစ်သည်။ ယခုလက်ရှိ Empathy ကိုသာ ပုံမှန် အစားထိုးသုံးလျက်ရှိသော်လည်း မြန်မာပြည်၏ MPT လိုင်းနှင့် အခြားသော Proxy ထည့်သွင်းရသော လိုင်းများအတွက်သင့်တော်သည်။
...
Kopete (http://kopete.kde.org/) ဆိုသည်မှာ Kubuntu Os (KDE) အတွက် default ပါ၀င်သော ချက်တင်
ဆော့လ်ဝဲဖြစ်သည်။
...
Konversation (http://konversation.kde.org/) သည် kubuntu တွင် default ပါ၀င်သော IRC ချက် ဆော့လ်ဝဲလ်ဖြစ်သည်။ mIRC အလားတူဆော့လ်ဝဲလ် တစ်ခုဖြစ်သည်။
...
ဆွဲယူကူးပြောင်းနိုင်မှုကို Ubuntu Geek (http://www.ubuntugeek.com/how-to-enable-drag-and-drop-capabilities-to-amsn.html) တွင် ဖတ်ရှုန်ိုင်သည်။
...
ယခင် Gnomemeeting ဟုသိခဲ့ကြသည့် Ekiga(http://www.gnomemeeting.org/) သည် SIP အား အပြည့်အ၀လိုက်နာသည့် function အပြည့်အစုံပါ VOIP နှင့် Video စနစ်ပါ အသုံးပြုနိုင်သော ပရိုဂရမ်ဖြစ်သည်။
...
တွင်  command တစ်ခုတည်း ရိုက်ထည့်ရုံဖြင့် လုပ်ဆောင်န်ိုင်ပါသည်။ ထို package များတွင် Adobe Flash 
Player, Jave Runtime Environment (JRE) (sun-java-jre) နှင့် Firefox plug-in (icedtea) များ ,
Microsoft မှ ထုတ်၀ေသော Font တချို့ (msttcorefonts) ,multimedia codecs (w32codecs or
...
ရယူလိုပါက ဤနေရာတွင်ကြည့်ပါ။) ,unrar archiver,odbc နှင့် cabextract  များပါ၀င်သည်။ ထို့အပြင်
...
[Gimp](http://www.gimp.org/) သည် အစွမ်းထက်သော စွမ်းရည်ပြည့်၀သည့် free open-source ဖြစ်ပါသည်။
...
source ပရိုဂရမ်ဖြစ်ပြီး KDE အတွက် ပြုလုပ်ထားသည့် KOffice Suite တွင် ပါ၀င်ပါသည်။ Dia ဖယောင်းမိတ္တူများ ပြုလုပ်၍ ရပါသည်။
...
တိုက်ရိုက်ပုံများကို upload လုပ်နိုင်ပါသည်။ အသေးစိ်တ်သိလိုပါက Picasa for Linux FAQ
...
ပါ၀င်သော ဆော့ဝဲများနှင့် နှိုင်းယှဉ်ပြရလျှင် --Writer (Word ကဲ့သို့ သုံးနိုင်သည်),Presentation (PowerPoint ကဲ့သို့  သုံးနိုင်သည်),Calc spreadsheet (Excel ကဲ့သို့ သုံးနိုင်သည်) , နှင့် Base relational database (Access ကဲ့သို့ သုံးနိုင်သည်)
...
အသုံး၀င်သည့် program အများအပြားရှိပါသည်။ Synaptic Package Manager တွင် pdf 
...
အလိုအလျောက် ထ﻿ည့်သွင်းပြီးသားဖြစ်သည်။ PDF ဖိုင်များသည် Evince နှင့် အလိုအလျောက်ဖွင့်နိုင်သည်။
...
Groupware တွင်  ၀ေမျှသုံးသော ပြက္ခဒိန်များ၊ Email server စုစည်းထားမှုများ၊ အစုအသင်းများ၏ လိပ်စာ စာရင်းများ၊ အသင်းအဖွဲ့များ၏ စီမံကိန်းများ နှင့် အသင်းအဖွဲ့များအတွင်း message ပို့ခြင်းများ ပါ၀င်သည်။ ၎င်းတို့သည် LAMP (သို့) အလားတူ ဆာဗာများ တစ်ခု (သို့) တစ်ခုထက်ပို၍ လိုအပ်သည်။
...
[Kolab](http://www.kolab.org/) သည်အပြည့်စုံဆုံးသော  Open- source groupware ဖြစ်ပြီး platform မျိုးစုံအတွက် ဖြန့်ချီထားသည်။ ၎င်းတို့သည် Ubuntu (Evolution အပါအ၀င်) KDE/Kunbuntu (Kcontact အပါအ၀င်) တို့နှင့် ကောင်းစွာ ပေါင်းစပ်အလုပ်လုပ်နိုင်သည်။   ၎င်းသည် အခမဲ့၊ GPL လိုင်စင်ဖြင့် ပွင့်လင်းရင်းမြစ်ဖြစ်သော်လည်း (အခြားအုပ်စုဖွဲ့ ဆော့ဝဲများနှင့် မတူသည့်အချက်မှာ) စီးပွားရေးလုပ်ငန်းသုံးအတွက် အကူအညီရခြင်းပင်ဖြစ်သည်။  ၎င်းသည် ကြီးမားသော အဖွဲ့အစည်းများအတွက် အသုံးပြုနိုင်သည့်အပြင် Outlook (MS -Exchange) နှင့် Mozilla တို့နှင့်လည်း တွဲဖက်နိုင်သည်။ သို့သော်ဂျာမန်ထုတ်ဖြစ်သည့်အတွက် အင်္ဂလိပ်ဘာသာဖြင့် အသုံးပြုနည်းတွင် အကန့်အသတ်များ ရံဖန်ရံခါ ရှိတတ်သည်။ 

Kolab ၀က်ဘ်ဆိုက်တွင် ရင်းမြစ်မှ တပ်ဆင်ပုံ (ယခုလက်ရှိ ဗ.၂.၂) အတွက် ညွှန်ကြားချက်များ ပေးထားသည်။ ဗားရှင်း ၂.၂ တွင် Horde ၀က်ဘ်ပုံစံပါ၀င်သည်။ လက်ရှိ ဘီတာအဆင့် ဒီဘီရန်းအတွက် ညွှန်ကြားချက်များမှာ [HERE](http://wiki.kolab.org/index.php/Debian) - Administrators - Kolab-Installation (သို့) OpenPkg အတွက် ညွန်ကြားချက်များမှာ [HERE](http://files.kolab.org/server/release/kolab-server-2.2.4/ix86-debian5.0/1st.README)
...
အသုံးပြုနည်း မပါ၀င်သေးသော Kolab version အသစ် (v.2.2) Ubuntu/ Kubuntu အတွက်လည်း ရှိပါသည်။ တပ်ဆင်ရန်မှာ
...
သင့်အနေဖြင့် မိမိ၏ အချက်အလက်များဖြစ်သည့် host ၏ အမည် ၊ (၎င်း ကို  hostname - f ဖြင့် သိနိုင်သည်) domain အသေးစိတ်အချက်အလက် စသည်တို့အား ဤအဆင့် မပြုလုပ်မီတွင် သိရှိထားသင့်ပါသည်။ Kolab သည် slabd open LDAP server တို့ကို အသုံးပြုမည်ဖြစ်သောကြောင့် [Open LDAP](http://www.openldap .org /) နှင့် [LDAP](http://en.wikipedia.org/ wiki /LDAP) ၏ အခြေခံအချက်အလက်များနှင့် ရင်းနှီးကျွမ်း၀င်မှု မရှိသေးပါက သင့်အနေဖြင့် လေ့လာထားသင့်ပါသည်။
...
[Citadel](http://www.citadel.org/) သည် အသင့်သုံး open source groupware ဖြစ်ပြီး KDE နှင့် Kolab-1 နှစ်မျိုးလုံးဖြင့် တွဲဖက်အသုံးပြုနိုင်သည်။ လွန်ခဲ့သည့် နှစ်ပေါင်း ၂၀ကျော်မှ Bulletin - board ပုံစံ framework အား အသုံးပြုထားသောကြောင့်  ၎င်းသည် KDE , Gnome နှစ်မျိုးစလုံးဖြင့်ရ ၀က်ဘ် အခြေပြု ပုံစံလည်း သုံးစွဲန်ိုင်သည်။ WebDAV နှင့်လည်း တွဲဖက်န်ိုင်ပြီး Thunderbird ဖြင့် လည်း အသုံးပြုနိုင်သည်။
...
[Sugar CRM](http://www.sugarcrm.com/crm/download) သည် ဖောက်သည်ဆိုင်ရာ စီမံခန့်ခွဲမှုစနစ်ဖြစ်ပြီးအရောင်းအင်အားစုများ (အရောင်း ၊ဈေးကွက်မြှင့်တင်ရေး၊ ထောက်ပံ့ရေး၊ စီမံခန့်ခွဲမှု ၊ အချိန်ခွဲ၀ေမှုများ) အကြားတွင် ပေါင်းစပ်ညှိနှိုင်းရာတွင် သုံးလေ့ရှိသည်။ Sugar CRM အဖွဲ့အစည်းပုံစံကို ကျယ်ကျယ်ပြန့်ပြန်သုံးစွဲကြသည်။ LAMP ဆာဗာကို ဦးစွာတပ်ဆင်သင့်သည်။ 

	sudo tasksel install lamp-server 

Sugar CRM ကို `/var/www` သို့ ဖြည်ထုတ်ပါ။ ထို့နောက် http://localhost/SUGAR-FOLDER/ သို့ Login ၀င်ပါ။ အခြားရွေးချယ်စရာအဖြစ် SugarCRM ဆာဗာအသစ်ကို LAMP နှင့် 
ွSugarCRM အဖွဲ့အစည်းပုံစံ အသင့်ပါပြီး တပ်ဆင်ရန် (ဘိုင်နာရီ) [instrallation](http://www.sugarcrm.com/crm/download#installers) ပုံစံဖြင့်လည်း ရနိုင်ပါသည်။
...
Kontact Personal Information Manager တကိုယ်ရည်သုံး အချက်အလက်မန်နေဂျာသည် ဦးဘန္တု တွင်တပါတည်းပါ၀င်ပြီးဖြစ်ပြီး အခြားသော အစုဖွဲ့ ဆော့ဝဲလ်များဖြင့် ကောင်းစွာအလုပ်လုပ်နိုင်သည်။ interfaces with many [groupware servers](http://kontact.kde.org/groupwareservers.php).

####KDE Groupware Wizard

KDE အုပ်စုဖွဲ့ဆော့ဝဲလ် အလိုအလျောက်ဆောင်ရွက်မှု  Kubuntu သည် အလိုအလျောက်ဆောင်ရွက်မှု (Script) ဖြင့် အုပ်စုဖွဲ့ ဆော့ဝဲလ်ဆာဗာနှင့် clients (Kontact/Kmail စသည်များ ) ကို ဆက်သွယ်နိုင်စေရန် ကူညီပေးသည်။ ယခုလက်ရှိ ထောက်ပံ့န်ိုင်သော အုပ်စုဖွဲ့ ဆော့ဝဲလ်များမှာ Kolab, eGroupware, SUSE Linux Openexchange နှင့် Novell Groupwise တို့ဖြစ်ကြသည်။
...
[Darwin Calendar Server](http://trac.calendarserver.org/) ပြက္ခဒိန် ဆာဗာသည် Apple ၏ [CalDAV](http://en.wikipedia.org/wiki/CalDAV ) ပွင့်လင်းရင်းမြစ် port ကို အခြေခံထားသော ပြက္ခဒိန်ဆာဗာ ဖြစ်ပြီး  Mozilla Thunderbird/ Lightening/ Sunbird/ Evolution နှင့် အခြားသော ပြက္ခဒိန် client များဖြင့် ကောင်းစွာအလုပ်လုပ်နိုင်သည်။ ရှင်း ၁.၂ ကို သိမ်းဆည်းထားသော နေရာများမှ တပ်ဆင်ရန်မှာ (အသေးစိ်တ်ညွှန်ကြားချက်များကို ၀က်ဘ်ဆိုက်တွင် ကြည့်ရှုပါ။ )
...
(Lightning) , Apple iCal, and Evolution ﻿စသည့် clients များဖြင့် တွဲဖက်သုံးနိုင်သည်။ နောက်ဆုံးဗားရှင်းကို [RSS]( http://en.wikipedia.org/wiki/RSS ) clients သုံးကာ ကြည့်ရှုနိုင်သည်။ နောက်ဆုံး ဗားရှင်း (၁.၂) ကို တပ်ဆင်ရန် ၀က်ဘ်ဆိုဒ် နှင့် [wiki](http://www.k5n.us/wiki/index.pmp?title=Main_Page)
...
၀က်ဘ်အခြေပြု မေးလ်အတွက်  Roundcubemail or Squirrelmail ၊ phpAdmin, Postfix Admin, and A Wstats တို့ကို ပါ၀င်သော package ဖြစ်သည်။ ၎င်းသည် Lucid 10.04 LTS တွင် အကောင်းဆုံးဖြစ်စေရန်စီမံထားပြီး ဆာဗာအသစ်ပေါ်တွင် တပ်ဆင်ရန် အကောင်းဆုံးဖြစ်သည်။ (၎င်းသည် အီးမေးလ် ဆိုင်ရာ ချိန်ညှိမှုဖိုင်များစွာကို မူလအနေအထား ဖြစ်စေရန် ပြုပြင်သောကြောင့်ဖြစ်သည် ) ၎င်း၏ အဖွဲ့အစည်းပုံစံတွင် စီးပွားဖြစ်ထုတ်လုပ်သော ပုံစံ၏ အရည်အသွေးများစွာပါ၀င်သည်။
...
[KMyMoney](http://kmymoney2.sourceforge.net/index-home.html) ကို ကျွမ်းကျင်အကောင့် (Accountants) သမားတွေ အသုံးပြုသလို အသုံးပြုနိုင်ပါသည်။ KMyMoney မှာလည်းပဲ MyMoney နှင့် Intuit Quicken ကဲ့သို့ ငွေစာရင်းတွေကို  double - accounting နဲ့ အသုံးပြုနိုင်သလို၊ လုပ်ငန်းအတွက်လဲ သက်ဆိုင်ရာ အမျိုးအစားအလိုက် စီမံနိုင်တဲ့ ဆော့ဝဲလ်ဖြစ်ပါသည်။ ကို KDE Kubuntu အတွက် ပြုလုပ်ထားတာဖြစ်ပြီး Gnome/Ubuntu တို့မှာလဲ သွင်းယူအသုံးပြုန်ိုင်ပါသည်။Install -
...
အသုံးပြုနေကြသည့်tool  များထဲတွင် ထိပ်ဆုံးမှရပ်တည်နေသည့် open-source  တစ်ခုဖြစ်သည်။ရိုးရှင်းသော  website  များမှသည်အလွန်ရှုပ်ထွေးသော website များအထိ အချိန်အနည်းငယ်ပေးလေ့လာရုံဖြင့် ဖန်တီးရေးဆွဲန်ိုင်သည့် module အခြေပြု wetside ဖန်တီးသည့် toolဖြစ်သည်။ စတင်သုံးစွဲနည်းတွင် သတင်းအချက်အလက်များ စုံစုံလင်လင် ရာယူန်ိုင်ပါသည်။ Drupal အသုံးပြုရန်အတွက် LAMP server အား 
(Install မလုပ်ရသေးပါက Install ပြုလုပ်ရန်လိုအပ်ပြီး Drupal နှင့် တပါတည်း Install  ပြုလုပ်နိုင်ပါသည်။ Drupal ကို MySQL database (LAMP ရှိ M) နှင့်အလွယ်တကူ အသုံးပြုန်ိုင်ပြီး PostgreSQL( Install 
...
အား Synaptic သို့မဟုတ် Kpackage Kit စသည့် package manager များ အသုံးပြုပြီး  Install ပြုလုပ်န်ိုင်သည်။ (K) Ubuntu OS အသစ်တွင် တိုက်ရိုက် Install ပြုလုပ်နိုင်ရုံသာမက Debian respository ကိုပါ (Download
page တွင် ဖော်ပြထားသည့် လမ်းညွှန်ချက်အတိုင်း ) ထည့်သွင်းနိုင်ပြီး Install ပြုလုပ်န်ိုင်သည်။

-Drupal6 မှ Drupal7 သို့ပြောင်းလဲရန်အတွက် [ဤလမ်းညွှန်ချက်](http://drupal.org/node/570162) များအတိုင်း ပြုလုပ်န်ိုင်ပါသည်။
...
[Plone](https://plone.org/) သည် ကမ ၻာအနှံ့ရှိ လုပ်ငန်းကြီးများတွင် အသုံးပြုနေသည့် content management system ဖြစ်ပြီး platform မျိုးစုံတွင် အခမဲ့ အသုံးပြုန်ိုင်သော open source (GPL - licensed ) system ဖြစ်သည်။ Installer ကို [ဒီနေရာ](http://plone.org/products/plone) တွင် ရယူနိုင်သည်။ Python ကို ပြောင်းလဲထားသောကြောင့် အချို့အသုံးပြုသူများအနေဖြင့် Jaunty တွင် အခက်အခဲတွေ့နိုင်ပါသည်။
...
[Dokeos](http://www.dokeos.com/) သည် အခမဲ့ သင်ကြားရေး platform တစ်ခုဖြစ်ပြီး ဆေးပညာဆိုင်ရာ ပုံများ၊ case presentation များပါ ပါ၀င်သည်။ ဥရောပတွင် ကျယ်ကျယ်ပြန့်ပြန့် အသုံးပြုနေကြပါသည်။
...
-အသုံးပြုလိုသော ပုံရိပ်တစ်ခုကို `/boot/grub` ဖ်ိုင်တွဲတွင် ထည့်၍ splashimage အနေဖြင့်အသုံးပြုနိုင်သည်။ ဥပမာ

	sudo in -s /usr /share /images /grub /Plasma-lamp.tga/boot/grub
	sudo update-grub

#####Grub 2 အား ချိုးဖောက်၀င်ရောက်ခြင်း မပြုနိုင်ရန် ကာကွယ်ခြင်း
...
#####Grub Legacy ကိုချိုးဖောက်၀င်ရောက်ခြင်းမပြုနိုင်ရန် ကာကွယ်ခြင်း
...
Ubuntu ၏ ယခင် version များတွင် သင် သတ်မှတ်ထားသော လုပ်ငန်းများအတွက် မည်သည့် program အား ပုံသေအသုံးပြုမည်ကို သင့်အနေဖြင့် ဤနေရာမှ ရွေးချယ်န်ိုင်သည်။
...
သင့်အနေဖြင့် encrypted  ပြုလုပ်ထားသည့် အရာများပါ၀င်သော folder တစ်ခု ဤလမ်းညွှန်ချက်များ  
...
ဤနည်းသည် ယခင် window user များ အကျွမ်းတ၀င်ရှိကြမည့်  Shoutcut များဖန်တီးသည့် ပုံစံဖြင့် ဆင်တူသော်လည်း ပို၍ အဆင့်မြင့် (စွမ်းအားမြင့်) ပါသည်။

##Assign a root password##

Root သို့ တ်ိုက်ရိုက် `log in`  ပြုလုပ်နိုင်ရန်အတွက်  root password ထည့်သွင်းပေးရန်လိုအပ်ပါသည်။ password ထည့်သွင်းရန်အတွက် 
...
တစ်ခုတည်းသော Network manager အား GUI interface ဖြင့် စတင်လုပ်ဆောင်စေနိုင်ပါသည်။ Network-Manager သည် ပုံမှန်အနေဖြင့် ပါ၀င်ပြီးဖြစ်သည်။ သို့သော်လည်း အသုံးပြုသူများသည် [Wicd Network Manager](http://wicd.sourceforge.net/)  ကို ပို၍ နှစ်သက်ကြသည်။
...
protocol,RDP )` ဟု ခေါ်သော သီးခြားအဖွဲ့အစည်း တစ်ခုပိုင် ပရိုတိုကောကို သုံးကြသည်။) `XDMCP (X Display Manager Control Protocol)` ဖြင့် လည်း` X-windows` ကို အခြေခံသည့် ပြီးပြည့်စုံသော Remote Login ကို ပြုလုပ်နိုင်ပါသည်။ ခွင့်မပြုသင့်သော ၀င်ရောက်ခြင်းများ ၊ဒေတာအချက်အလက် ပို့ဆောင်ခြင်းများကို 
ကာကွယ်ပေးသော သင့်တော်သည့် ကြိုတင်ကာကွယ်မှုများမရှိလျှင် `Remote Connection` သည် လုံခြုံရေးအရ အန ၱရာယ်ရှိပေသည်။ 
...
ကျွန်တော့အမြင်မှာတော့ ဒါဟာ အလွန်အန ၱရာယ်ရှိတဲ့ လုပ်ဆောင်ချက်တစ်ခုဖြစ်ပါတယ်။။ အစက်လေးတစ်စက်ဟာ
...
##User စကားဝှက်အသုံးပြုရန် မလိုပဲ ၀င်ရောက်သောစနစ်##
...
(password စသည့် )တုံ့ပြန်မေးခွန်းများ မေးမြန်းခြင်းများအား ဖြေဆိုရန် script တိုလေးများအား Menu item ထဲတွင် ထည့်သွင်းနိုင်ပါသည်။ အောက်တွင် SSH Negotiation ပြုလုပ်စဉ် password ထည့်ပေးနိုင်သည့် ဥပမာအား ဖော်ပြပေးထားပါသည်။ ပထမဦးစွာ အသုံး၀င်  [expect](http://linux.die.net/man/1/expect) program အား install ပြုလုပ်ပါ။
...
ထို့ကြောင့် Menu Iten ကို terminal တွင်သာ run   စေရမည်ဖြစ်္္္္သည်။
...
ကျပန်း password geneartor
	...
	-Pwgen သည် ကျပန်း password စာလုံးစုများထုတ်ပေးရန်အတွက်  အသုံး၀င်သည့် command line
...
-UUIDgen သည် ကျပန်း UUID များအား ထုတ်ပေးသည့် အသုံး၀င်သော
...
John the Ripper သည် Dictionary ၏ password များအား ဖျက်ရန်အတွက် အခမဲ့အသုံးပြုနိုင်သော open source ဖြစ်ပြီး ယေဘုယျအားဖြင့် ၎သန်းခန့် ဘာသာပေါင်းစုံဖြင့် အသုံးပြုနေကြသည်။ အဘယ်ကြောင့်ဆိုသော်
...
အသုံး၀င်သောကြောင့်ဖြစ်သည်။ Install ပြုလုပ်ရန်
...
[Alien](http://kitenet.net/~joey/code/alien/) သည် (Red Hat) .rpm packages များကို  (Debian).deb packages များအဖြစ်သို့ ပြောင်းလဲပေးသော ဖိုင်ပြောင်းနည်းတစ်ခုဖြစ်သည်။ ဒီနည်းဟာ စိတ်ချရတဲ့နည်းမဟုတ်သလို ပြောင်းလိုက်တဲ့ package တွေရဲ့ function တွေကို သေချာပြန်စစ်ဆေးပေးဖို့လိုအပ်ပါတယ်။ များသောအားဖြင့် စာကြောင်းတွေ ပြန်ပြောင်းပေးဖို့ လိုအပ်ပါတယ်။ Source ကနေ `(Debian).deb package` ကို ပြောင်းပေးခြင်းက ပိုပြီးစိတ်ချရပါတယ်။ Alien software ရဲ့ maintainer တွေ က်ိုယ်တိုင်ကိုက important package တွေကို ဖိုင်ပြောင်းတဲ့အခါ Alien ကို အသုံးမပြုစေချင်ကြပါဘူး။ Alien ကို version နံပါတ်တွေ ပြောင်းတာကနေ ထိန်းထားချင်တယ်ဆိုရင်တော့ ဖော်ပြပါ command ကို ရိုက်ထည့်ပေးပါ။
...
မှတ်ချက် ။    user ဆိုသော နေရာတွင် သင့် username အမှန်အား ထည့်ပေးပါ။ ဤ command သည် folder ၏ ပိုင်ရှင်အား ပြောင်းလဲပေးမည်ဖြစ်သည်။ `-R` အပါအ၀င်  (recursively ) ကိုဆိုလိုပြီး folder အခွဲများပါ ပါ၀င်ပါသည်။
...
မှတ်ချက်။ `chmod 777` သည် folder အား လုပ်ပိုင်ခွင့်အပြည့်အစုံပေးလိုက်သည့် universal option ဖြစ်သည်။ `777` ဆိုသော ဂဏန်းသည် ရေးခြင်း၊ ဖတ်ခြင်း ၊လုပ်ဆောင်ခြင်း စသည့် လုပ်ပိုင်ခွင့် တို့ကို အသုံးပြုသူအား အပြည့်အ၀ ပေးလိုက်သည်ဟု အဓိပ္ပါယ် ရသည်။
